...
@section('content')
    <x-h1 class="width-full flex-center margin-bottom-40px">Registration</x-h1>
    ...
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <section class="flex-center flex-column">
            <div class="flex-column width-368px">
                <x-label class="flex-center margin-bottom-7px">Profile's Picture:</x-label>
                <x-input.picture name="picture" class="flex-center margin-inline-auto width-200px" required value="{{ old('picture') }}">
                    Choose A Picture
                </x-input.picture>
            ...
            <div class="flex-column margin-top-20px">
                <x-label class="margin-bottom-7px" required>Full Name:</x-label>
