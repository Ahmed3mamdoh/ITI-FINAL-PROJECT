...
@section('content')
    <x-h1 class="width-full flex-center margin-bottom-40px">All Authors:</x-h1>

    @if($authors->count() == 0)
        <x-h3 class="width-full flex-center">No authors available yet.</x-h3>
    @else
        <x-table.container>
            <x-table class="table--1500px">
    ...
    <section class="flex-center margin-top-50px">
